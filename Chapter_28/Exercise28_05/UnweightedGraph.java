...
Description: Exercise 28-5 from Intro to Java.   This is the UnweightedGraph, (with the Edge class tacked on)
I've added a method with the header: public List<Integer> getPath(int u, int v)  that finds the best path from
vertex u to vertex v.

I had to make some minor adjustments as well due to deprecated code, which I've marked.
The deprecated new Integer(i) needed to be replaced with Integer.valueOf(i), otherwise the code has a compile error
in my IDE.
 */
...
public class UnweightedGraph<V> implements Graph<V> {
	...
	public UnweightedGraph(List<Edge> edges, int numberOfVertices) {
		for (int i = 0; i < numberOfVertices; i++)
			addVertex((V) Integer.valueOf(i)); // Replace deprecated `new Integer(i)`
