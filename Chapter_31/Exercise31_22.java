...
Description:  This is a revision of Listing 31.4 From Intro to Java by Daniel Liang
The program demonstrates the use of TableView to list details about countries
in table format.   I've added a button that can delete a selected row, and
some minor error handling in the case of invalid input from the user.
 */
...
public class Exercise31_22 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //(I've also added some error handling)
        btAddRow.setOnAction(e -> {
            try {
                ...
                tfCapital.clear();
                tfPopulation.clear();
                chkDemocratic.setSelected(false); //clear checkbox
                lblError.setText("");
            } catch (NumberFormatException ex) {
                lblError.setText("Invalid population value.  Please enter a number.");
            }
        });
        ...
        btDeleteRow.setOnAction(e -> {
            ...
            if (selectedItem != null) {
                ...
                tableView.getSelectionModel().clearSelection(); //Clear the selection
                lblError.setText("");
            } else {
                lblError.setText("No row selected.");
            }
        });
